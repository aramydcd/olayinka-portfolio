...
Data Tools: Power BI (DAX, Power Query), SQL
...
Bash
git clone https://github.com/aramydcd/olaynka-portfolio.git
cd olaynka-portfolio
...
├── portfolio/          # Portfolio app (models, views, api)
├── media/              # Uploaded dashboard screenshots (gitignored)
├── static/             # CSS, JS, and Brand Assets
├── templates/          # HTML Layouts (Bootstrap 5)
